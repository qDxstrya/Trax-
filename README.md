> This is **Trax+**, a standalone openGym-based app with selected workout features from Trax. The original openGym architecture remains the base; see [TRAX_PLUS.md](TRAX_PLUS.md) for the Trax+ additions and setup.

<div align="center">

<img src="assets/banner.png" alt="Trax+" width="720">
